        ...
        group.MapPut("/{id}", async (int id, Cartitem input) =>
        {
            using (var context = new DirtbikeContext())
            {
               ...
               if (input.Parkname != null) someCartitem[0].Parkname = input.Parkname;
				...
				if (input.Adults != null) someCartitem[0].Adults = input.Adults;
				if (input.Children != null) someCartitem[0].Children = input.Children;
				if (input.Statetaxpercent != null) someCartitem[0].Statetaxpercent = input.Statetaxpercent;
				if (input.Statetaxauth != null) someCartitem[0].Statetaxauth = input.Statetaxauth;
				if (input.Ustaxpercent != null) someCartitem[0].Ustaxpercent = input.Ustaxpercent;
				if (input.Ustaxtotal != null) someCartitem[0].Ustaxtotal = input.Ustaxtotal;
				if (input.Statetaxtotal != null) someCartitem[0].Statetaxtotal = input.Statetaxtotal;
				if (input.Itemsubtotal != null) someCartitem[0].Itemsubtotal = input.Itemsubtotal;
