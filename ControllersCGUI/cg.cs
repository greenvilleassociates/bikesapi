...
/* THE CAPGEMENI PARK STRUCTURE IS A SUBSET OF THE GAUS PARK MODEL. IT ALSO ELIMINATES PRODUCT SALES CATALOGUE AS EACH PARK HAS A SINGLE ADULT AND CHILD PRICE */
/* WE HAVE BUILT A DTO CG PARK SO THESE ENDPOINTS ARE A BIT DIFFERENT */
...
public static class ParksEndpoints
{
    ...
    {
        var group = routes.MapGroup("/CG/Parks").WithTags(nameof(Park));
        ...
        .WithName("CGRemoveSomeParkGuests")
        .WithOpenApi();
